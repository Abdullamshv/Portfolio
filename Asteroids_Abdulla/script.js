...
function animate() {
  ...
  // console.log(animate) // to check whetther it is working or not
  c.fillStyle = "black";
  ...
  if (keys.d.pressed) player.rotation += 0.01 * SPEED;
  else if (keys.a.pressed) player.rotation -= 0.01 * SPEED;
}
